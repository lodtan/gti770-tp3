...
def mlp_benchmark(X_train ,y_train ,X_test ,y_test ,n_hidden_1=10 ,learning_rate=0.005 ,training_epochs=20 ,batch_size=100):
    ...
    with tf.Session() as sess:
        ...
        for i in range(total_batch):
            ...
            # optimisation et backpropagation => valeurs du cout sur training ET validation
        ...
        df1['category'] = 'train'
        df2 = pd.DataFrame(epoch_vs_cost_valid, columns=['epoch', 'cost'])
        df2['category'] = 'valid'
...
if __name__ == "__main__":
    ...
    a = mlp_benchmark(X_train, Y_train, X_test, Y_test, n_hidden_1=n_hidden_1, learning_rate=0.01, training_epochs=500,batch_size=100)
